...
public class AREditText extends AppCompatEditText {
	...
	private void init() {
		...
		//String data = "sdsksdskfjsdklafjkadsl fsdfnas dfnklsdafjkadslf";
		this.setFocusableInTouchMode(true);
		this.setBackgroundColor(Color.WHITE);
		this.setHint("Type Here....!");
		//this.setText("SKJKadsjkasdkdA DASKJDHASD ASD ASDJASDJ Kdj kaljdkljdkSDASJDKLasdja");
	...
	private void setupTextWatcher() {
		mTextWatcher = new TextWatcher() {
			...
			public void beforeTextChanged(CharSequence s, int start, int count, int after) {
				...
				//Log.e("Commment text====11==> " , s.toString());
				// DO NOTHING FOR NOW
			}
			...
			public void onTextChanged(CharSequence s, int start, int before, int count) {
				...
				Log.e("Commment text====22==> " , s.toString());
			}

			@Override
			public void afterTextChanged(Editable s) {
				//Log.e("Commment text====33==> " , s.toString());
				if (!MONITORING) {
					return;
				}
	...
	public String getHtml() {
		...
		Log.e("datat comment====> ",htmlContent);
